...
class TestULBEventGenerator:
    ...
    def _create_test_csv(self, data: dict) -> Path:
    ...
    def test_init_loads_data(self):
        ...
        csv_path = self._create_test_csv(csv_data)
        try:
    ...
    def test_features_dict_excludes_special_columns(self):
    ...
    def test_ulb_structure_with_many_features(self):
    ...
    def test_amount_fallback_columns(self):
    ...
    def test_label_fallback_columns(self):
    ...
    def test_empty_csv_raises_error_on_init(self):
    ...
    def test_empty_dataframe_raises_error_on_call(self):
    ...
    def test_all_feature_columns_included(self):
    ...
    def test_mixed_nan_and_numpy_types(self):
